...
const destination = getDestinationBySlug('spain')!
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <section className="py-12">
          <div className="bg-gradient-to-r from-red-500 to-yellow-500 text-white rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to Move to Spain?</h2>
            <p className="text-xl text-red-100 mb-8">
              Explore jobs, connect with services, and start your relocation journey.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/jobs?country=spain" className="bg-white text-red-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-red-50 transition-all shadow-lg">
                Browse Spain Jobs
              </Link>
              <Link href="/services?country=spain" className="bg-red-700/50 backdrop-blur-sm text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-red-700/70 transition-all border border-white/20">
